...
/*
 * It is just a helper class which should be replaced by database implementation. It is not very well written class, it
...
public class CountryService {
  ...
  public Country getCountry(int id) throws CountryNotFoundException {
